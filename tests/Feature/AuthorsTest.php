...
class AuthorsTest extends TestCase
{
         ...
         * @test
        */
        public function it_returns_all_authors_as_collection_of_resource_objects()
        {
        ...
        * @test
        */
        public function it_validates_that_the_type_member_has_the_value_of_authors_when_creating_an_()
        {
            $user = factory(User::class)->create();
            Passport::actingAs($user);
            $this->postJson('/api/v1/authors', [
        ...
        */
        ...
        public function it_validates_that_the_type_member_has_the_value_of_authors_when_updating_an_()
        {
            $user = factory(User::class)->create();
            Passport::actingAs($user);
            $author = factory(Author::class)->create();
